...
class ExportTransactionAdmin (admin.ModelAdmin):
    ...
    list_display = ('export_uuid', 'timestamp', 'render', 'status',
                    'app_label', 'object_name', 'export_change_type',
                    'exported', 'received', 'received_datetime', 'created',)

    list_filter = ('status', 'exported', 'received', 'app_label',
                   'object_name', 'export_change_type', 'received_datetime', 'created')
