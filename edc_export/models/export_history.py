...
class ExportHistory(SyncMixin, BaseUuidModel):
    ...
    export_filename = models.CharField(max_length=250, help_text='original filename on edc_export')
    ...
    sent = models.BooleanField(default=False, help_text='edc_export file sent to recipient')
