...
#
# from .models import TestCrfModel1
#
#
# class TestExportAsCsv(TestCase):
#
...
#             [], model=TestCrfModel1, fields=fields, extra_fields=extra_fields)
#         self.assertTrue(set(['f1', 'f2', 'f3', 'f4', 'f5'])
#                         < set(export_as_csv.field_names))
#
#     def test_field_names1(self):
#         """Correctly sets field names based on the given model."""
#         test_crf_model1 = TestCrfModel1.objects.create(
#             test_visit_model1=self.test_visit_model1)
#         for _ in range(0, 10):
...
#         export_as_csv = ExportAsCsv(
#             queryset, model=TestCrfModel1, extra_fields=extra_fields)
#         export_as_csv.field_names.sort()
#         field_names = [
#             fld.name for fld in TestCrfModel1._meta.fields] + extra_fields.keys()
#         field_names.sort()
#         self.assertEqual(export_as_csv.field_names, field_names)
#
...
#         names = ['f10', 'f11']
#         export_as_csv = ExportAsCsv(
#             queryset, model=TestCrfModel1, fields=names)
#         export_as_csv.field_names.sort()
...
#         names = ['f1', 'f2']
#         export_as_csv = ExportAsCsv(
#             queryset, model=TestCrfModel1, exclude=names)
#         export_as_csv.field_names.sort()
#         field_names = [
#             fld.name for fld in TestCrfModel1._meta.fields if fld.name not in names]
#         field_names.sort()
#         self.assertEqual(export_as_csv.field_names, field_names)
#
...
#         export_as_csv = ExportAsCsv(
#             queryset, model=TestCrfModel1, fields=names, show_all_fields=False)
#         self.assertEqual(export_as_csv.field_names, [
#                          'subject_identifier', 'f1', 'hostname_created'])
#
...
#             queryset, model=TestCrfModel1, fields=names, show_all_fields=False)
#         self.assertEqual(export_as_csv.field_names, [
#                          'subject_identifier', 'f1', 'f2', 'hostname_created'])
#         self.assertEqual(export_as_csv.header_row, [
#                          'subject_identifier', 'f1', 'f2', 'hostname_created'])
#
...
#             test_crf_model1.save()
#         queryset = TestCrfModel1.objects.all()
#         names = ['f1', 'hostname_created', 'f2',
#                  'report_datetime', 'subject_identifier']
#         export_as_csv = ExportAsCsv(
#             queryset, model=TestCrfModel1, fields=names, show_all_fields=False)
#         self.assertEqual(
...
#                  'report_datetime', 'f2', 'subject_identifier', 'f3']
#         export_as_csv = ExportAsCsv(
#             queryset, model=TestCrfModel1, fields=names, show_all_fields=False)
#         self.assertEqual(
#             export_as_csv.field_names,
...
#         test_crf_model = TestCrfModel1.objects.create(
#             test_visit_model1=self.test_visit_model1)
#         queryset = TestCrfModel1.objects.all()
#         names = ['f1', 'hostname_created', 'report_datetime',
#                  'report_datetime', 'f2', 'subject_identifier', 'f3']
...
#         TestCrfModel1.objects.create(test_visit_model1=self.test_visit_model1)
#         queryset = TestCrfModel1.objects.all()
#         fields = ['f1', 'hostname_created',
#                   'report_datetime', 'report_datetime', 'f2', 'f3']
#         extra_fields = {
#             'bad_dog': 'test_visit_model1__appointment__registered_subject__bad_dog'}
#         export_as_csv = ExportAsCsv(
...
#         self.assertEqual(len(export_as_csv.fetch_row()),
#                          len(export_as_csv.header_row))
#
...
#         self.assertEqual(ExportHistory.objects.filter(
#             pk_list__contains=test_crf_model.pk).count(), 1)
#
...
#         test_crf_model = TestCrfModel1.objects.create(
#             test_visit_model1=self.test_visit_model1)
#         self.assertEqual(ExportTransaction.objects.get(
#             tx_pk=test_crf_model.pk).export_change_type, 'I')
#
...
#         self.assertTrue(
# ExportTransaction.objects.get(tx_pk=pk,
# export_change_type='D').export_change_type, 'D')
